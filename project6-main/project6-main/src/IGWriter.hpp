/**
   ...
   different/more colors for visualizing your register allocation algorithm
   output.
...
#ifndef __PROJ6_IG_WRITER__HPP
#define __PROJ6_IG_WRITER__HPP
...
class IGWriter {
   public:
    static void write(const InterferenceGraph<Variable> &igraph,
